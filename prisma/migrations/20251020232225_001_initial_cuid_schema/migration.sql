...
-- CreateIndex
CREATE UNIQUE INDEX "usage_tracking_workspace_id_key" ON "usage_tracking"("workspace_id");
...
-- AddForeignKey
ALTER TABLE "usage_tracking" ADD CONSTRAINT "usage_tracking_workspace_id_fkey" FOREIGN KEY ("workspace_id") REFERENCES "workspaces"("id") ON DELETE CASCADE ON UPDATE CASCADE;
